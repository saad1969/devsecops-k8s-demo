pipeline {
  ...
  stages {
    ...
    stage('SonarQube - SAST') {
      steps {
        sh "mvn sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.host.url=http://devsecopse.eastus.cloudapp.azure.com:9000  -Dsonar.login=9d06b93f8870cc23ab8729fecf096cf17abe1395"
      }
    }
